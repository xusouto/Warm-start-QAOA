...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--png", type=Path, default=Path("/mnt/netapp1/Store_CESGA/home/cesga/jsouto/WS_GitHub/RoundQulacs/energy_vs_eps.png"),
                   help="Output PNG path (default: energy_vs_eps.png).")
    p.add_argument("--csv", type=Path, default=Path("/mnt/netapp1/Store_CESGA/home/cesga/jsouto/WS_GitHub/RoundQulacs/averaged_energy.csv"),
