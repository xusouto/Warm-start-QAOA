...
def QUBO_to_Ising(Q: Tensor) -> Tuple[Tensor, List[float], float]:
    ...
    - pauli_terms: A list of 0/1 series, where each element represents a Pauli term.
    ...
    - offset: A float representing the offset term of the Ising Hamiltonian.
    """
    n = Q.shape[0]
...
def cost(n,pauli_terms: List[List[float]],weights: List[float],gamma):
    ...
    pauli_terms: list of 0/1 masks, len = m, each of length n
...
qp2 = create_problem1(mu, sigma, B, q, l)                                                                  # Creation of quadratic program for CPLEX 
# -------------------------------------------------------------------------------------------------------
# Minimum eigenvalue using Qiskit
# -------------------------------------------------------------------------------------------------------
