...
cut_pos = args.cut
# Cut info
with open(f"Cuts/cuts{n_}_{flag}_{iteration}.json", "r", encoding="utf-8") as f:
...
out_dir = Path("/mnt/netapp1/Store_CESGA/home/cesga/jsouto/WS_GitHub/RoundStart/Recursive/Probabilities")
